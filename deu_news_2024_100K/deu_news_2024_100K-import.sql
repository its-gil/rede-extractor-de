...
CREATE DATABASE `deu_news_2024_100K`;

USE `deu_news_2024_100K`;
...
LOAD DATA LOCAL INFILE 'deu_news_2024_100K-words.txt' INTO TABLE words CHARACTER SET utf8mb4;
LOAD DATA LOCAL INFILE 'deu_news_2024_100K-sentences.txt' INTO TABLE sentences CHARACTER SET utf8mb4;
LOAD DATA LOCAL INFILE 'deu_news_2024_100K-co_s.txt' INTO TABLE co_s CHARACTER SET utf8mb4;
LOAD DATA LOCAL INFILE 'deu_news_2024_100K-co_n.txt' INTO TABLE co_n CHARACTER SET utf8mb4;
LOAD DATA LOCAL INFILE 'deu_news_2024_100K-inv_w.txt' INTO TABLE inv_w CHARACTER SET utf8mb4;
LOAD DATA LOCAL INFILE 'deu_news_2024_100K-inv_so.txt' INTO TABLE inv_so CHARACTER SET utf8mb4;
LOAD DATA LOCAL INFILE 'deu_news_2024_100K-sources.txt' INTO TABLE sources CHARACTER SET utf8mb4;
LOAD DATA LOCAL INFILE 'deu_news_2024_100K-meta.txt' INTO TABLE meta CHARACTER SET utf8mb4;
